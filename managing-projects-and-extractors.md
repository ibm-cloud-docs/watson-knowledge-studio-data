...
The following are examples of regular Java expressions that might be used in specific instances. In the pattern descriptions, A represents a character and 9, a digit. For more information about Java syntax, see http://docs.oracle.com/javase/8/docs/api/java/util/regex/Pattern.html.
...
1. Create an **Advanced Rules** workspace
   - Complete step 1 of [Creating an advanced rules model](/docs/watson-knowledge-studio-data?topic=watson-knowledge-studio-data-create-advanced-rules-model#create-advanced-rules-model-procedure)
...
1. Complete step 6 of [Creating an advanced rule model](/docs/watson-knowledge-studio-data?topic=watson-knowledge-studio-data-create-advanced-rules-model#create-advanced-rules-model-procedure)
